...
function App() {
  return (
    <div className="min-h-screen bg-deep-twilight text-white font-sans selection:bg-light-green selection:text-black flex flex-col relative overflow-hidden">
      ...
      <main className="flex-1 flex flex-col items-center px-6 pt-8 pb-20 relative z-0">
        <div className="max-w-4xl w-full text-center space-y-8">
          ...
          <p className="text-lg md:text-xl text-frozen-water/80 max-w-2xl mx-auto leading-relaxed font-medium">
          ...
          <div className="pt-8 flex flex-col items-center justify-center gap-4">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <button
                onClick={() => window.open("https://jmng2-dl.jioaicloud.com/download/files/e6b79547cd004abf806d6f3acb23a805?vdc=jmng2&apiKey=c153b48e-d8a1-48a0-a40d-293f1dc5be0e&devicetype=web&ts=1771761618614", "_blank")}
                className="group relative w-full sm:w-auto flex items-center justify-center gap-3 bg-light-green text-black px-8 py-4 rounded-xl font-bold text-lg hover:bg-[#a6f082] transition-all hover:-translate-y-1 hover:shadow-[0_10px_40px_-10px_rgba(152,232,116,0.5)]"
              >
              ...
              <button className="w-full sm:w-auto flex items-center justify-center gap-2 bg-indigo-ink/30 text-white px-6 py-4 rounded-xl font-bold text-base hover:bg-indigo-ink/50 border border-violet-twilight/30 transition-all">
                View Features
              </button>
            </div>
            ...
            {/* Trust Strip */}
            <div className="mt-4 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs font-semibold text-frozen-water/50">
          ...
          <div className="pt-16 max-w-5xl mx-auto px-4">
            <div className="flex flex-col items-center">
              ...
              <div className="relative group w-full">
                ...
                <div className="mt-6 grid grid-cols-3 gap-4 md:gap-8 max-w-4xl mx-auto">
                  <div className="p-4 rounded-xl bg-indigo-ink/20 border border-violet-twilight/10 backdrop-blur-sm group/stat hover:bg-indigo-ink/30 transition-colors flex flex-col items-center justify-center">
                    <div className="text-2xl md:text-4xl font-black text-light-green tabular-nums tracking-tighter drop-shadow-sm">124</div>
                    <div className="text-[9px] md:text-[10px] uppercase tracking-widest text-frozen-water/50 font-bold mt-1 text-center">Processes Detected</div>
                  </div>

                  {/* Highlighted Middle Metric */}
                  <div className="p-6 rounded-xl bg-indigo-ink/40 border-2 border-light-green/40 backdrop-blur-md group/stat hover:border-light-green/60 hover:shadow-[0_0_30px_rgba(152,232,116,0.15)] transition-all flex flex-col items-center justify-center transform scale-110 z-10">
                    <div className="text-4xl md:text-6xl font-black text-light-green tabular-nums tracking-tighter drop-shadow-lg">87<span className="text-3xl md:text-4xl">MB</span></div>
                    <div className="text-[10px] md:text-xs uppercase tracking-widest text-frozen-water/80 font-bold mt-2 text-center">Memory Freed</div>
                  </div>

                  <div className="p-4 rounded-xl bg-indigo-ink/20 border border-violet-twilight/10 backdrop-blur-sm group/stat hover:bg-indigo-ink/30 transition-colors flex flex-col items-center justify-center">
                    <div className="text-2xl md:text-4xl font-black text-light-green tabular-nums tracking-tighter drop-shadow-sm">12</div>
                    <div className="text-[9px] md:text-[10px] uppercase tracking-widest text-frozen-water/50 font-bold mt-1 text-center">Apps Closed</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="pt-32 pb-16 w-full relative">
            ...
            <div className="max-w-6xl mx-auto px-4 text-center">
              <h2 className="text-3xl md:text-4xl font-extrabold mb-16 tracking-tight">Why CleanSweep?</h2>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
                {[
                  ...
                  <div key={i} className="p-8 rounded-2xl bg-deep-twilight/40 border border-violet-twilight/20 backdrop-blur-md flex flex-col items-center text-center group hover:border-light-green/40 hover:bg-deep-twilight/60 transition-all duration-300 hover:shadow-[0_0_30px_rgba(92,73,185,0.15)]">
          ...
          <div className="pt-24 max-w-4xl mx-auto text-center">
            <h3 className="text-2xl font-bold text-white mb-6">Take CleanSweep Everywhere</h3>
            <p className="text-frozen-water/80 mb-10 text-lg">We are actively developing native applications for mobile devices. Get notified the moment they drop.</p>
            ...
            <div className="flex flex-col items-center max-w-2xl mx-auto">
              <div className="flex flex-col sm:flex-row items-stretch justify-center gap-4 w-full">
                <input
                  ...
                  className="flex-1 px-6 py-5 rounded-xl bg-deep-twilight/50 border border-violet-twilight/40 text-white placeholder-frozen-water/50 focus:outline-none focus:border-light-green focus:ring-1 focus:ring-light-green transition-all shadow-inner text-lg"
                />
                <button className="flex items-center justify-center gap-2 bg-indigo-ink/80 text-white border border-violet-twilight/50 px-10 py-5 rounded-xl font-bold hover:bg-indigo-ink transition-colors whitespace-nowrap text-lg shadow-lg">
      ...
      <footer className="pt-16 pb-8 border-t border-indigo-ink/30 relative z-10 bg-[#0A071A]">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="pt-8 border-t border-violet-twilight/10 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-frozen-water/40">
